# Generated by Django 4.2.1 on 2023-07-14 20:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('waiting', 'Waiting'), ('active', 'Active'), ('closed', 'Closed')], default='waiting', max_length=25)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
